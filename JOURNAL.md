...
turns out sk6812mini-e's are a standard led that are supported by qmk - so i decided to use those<br \>
looked for a pinout online and wired everything up.<br \>
<img width="1610" height="773" alt="image" src="https://github.com/user-attachments/assets/c0af1f3e-3505-4f41-83e1-284ffd6e18c3" /><br \>
i decided not to hook any gpio pins up yet, because i want to make the connections as clean as possible.<br \>
i then found a 1.8 inch lcd screen that i want to build around, so i found the pinout for that and wired it up.<br \>
<img width="331" height="219" alt="image" src="https://github.com/user-attachments/assets/5d68a3e7-9443-4a01-a671-5bc8df64e694" /><br \>
finally, i assigned footprints to each of the components, and am ready to begin pcb routing!<br \>
and here is the final schematic!<br \>
<img width="4096" height="2896" alt="image" src="https://github.com/user-attachments/assets/3357a914-adaf-402b-acfa-bce59beb8dca" /><br \>
<br \>
<b>entry time - 1 hour 2 minutes</b><br \>
<b>total time - 1 hour 2 minutes</b>
<hr>
